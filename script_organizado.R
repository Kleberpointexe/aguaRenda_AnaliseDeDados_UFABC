...
dadosAtendidosBruto<-read_excel("ConsolidadoMunicipio.xlsx")  #dados do SNIS
dadosNaoAtendidos<-read_excel("rendaEconsumo.xlsx") #dados do snis + IBGE

#lendo a malha municipal
brMunicipios<-read_sf("dadosMapas/BR_Municipios_2024/BR_Municipios_2024.shp")
